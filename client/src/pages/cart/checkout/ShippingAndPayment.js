        ...
        <div className={classes['checkout-shipping-payment']}>
            ...
            <div className={classes.shipping}>
                <div className={classes.title}>
                    ...
                    <div><a href='client/src/pages/cart/checkout/ShippingAndPayment#'>Change</a></div>
                </div>
                <div>{user.user_address}</div>
                <div>{user.user_phone}</div>
                <div><a href='client/src/pages/cart/checkout/ShippingAndPayment#'>Add Delivery Instruction</a></div>
            </div>
